...
class HabitatClient extends EventEmitter
{
  ...
  messageReceived(_habitatMessage)
  {
    ...
    {
      this.emit('entitystatechanged', habitatMessage.entityId, habitatMessage.entity, { path: habitatMessage.path, value: habitatMessage.value, previousValue : habitatMessage.previousValue }, habitatMessage.state, habitatMessage.originator, habitatMessage.specification)
    }
  }
